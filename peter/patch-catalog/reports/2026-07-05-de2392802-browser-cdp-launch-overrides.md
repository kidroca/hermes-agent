...
- Patch ref: `de2392802`, `a45790619`, `6a726be99` (reviewed) → `e4eed0b1a` + `41be3faa9` + `ed0c4edc8` (pre-2026-08-09 active) → `0c77b22982` + `42e16962a0` + `6fbd0ccd7a` (pre-2026-08-14 active) → `b7edc3f88e` + `61dc02f515` + `99d093ca4a` (pre-refresh active) → `e1f9e33e00` + `95c3446380` + `9f75ed9a26` (pre-2026-08-23 active) → `fdff3c5f95` + `4db2906daf` + `f292be73ea` (pre-final-refresh active) → `edb594933a` + `f4d5a6167c` + `f9981154c7` (pre-2026-08-27 active) → `6db7a6f887` + `7b019f8643` + `cdec053d85` (pre-final-refresh active) → `025484e4b6` + `bc989c2023` + `abf406a87b` (pre-final-refresh-2 active) → `6e5b507b06` + `d391adb58e` + `3c76a804d5` (pre-2026-08-31 active) → `a3f2575166` + `98351b44dc` + `30fbcd8ac3` (pre-2026-09-05 active) → `9ac81e8564` + `0a5e5a0f12` + `58b8111b42` (active)
