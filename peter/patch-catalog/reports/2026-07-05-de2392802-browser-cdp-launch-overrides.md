...
- Patch ref: `de2392802`, `a45790619`, `6a726be99` (reviewed) → `e4eed0b1a` + `41be3faa9` + `ed0c4edc8` (pre-2026-08-09 active) → `0c77b22982` + `42e16962a0` + `6fbd0ccd7a` (pre-2026-08-14 active) → `b7edc3f88e` + `61dc02f515` + `99d093ca4a` (pre-refresh active) → `e1f9e33e00` + `95c3446380` + `9f75ed9a26` (active)
