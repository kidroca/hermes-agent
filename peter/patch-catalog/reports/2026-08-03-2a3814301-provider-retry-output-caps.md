...
- Patch ref: `2a381430193d652989e064fc91e856b45ec5f217` → `555d077a4` (pre-2026-08-09 active) → `e506a696e3` (pre-2026-08-14 active) → `e923efb3f6` (pre-refresh active) → `c9519c86e3` (active)
