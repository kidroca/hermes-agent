...
- Patch ref: `c7bb02582`, `bd2740267` (reviewed) → `4e5278808` + `ec22e73cb` (pre-2026-08-09 active) → `5e739d034e` + `0e7f68a806` (pre-2026-08-14 active) → `21e6282757` + `ba0691c254` (active)
