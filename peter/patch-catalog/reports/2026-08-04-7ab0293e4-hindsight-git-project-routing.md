...
- Patch ref: `7ab0293e4` (`7ab0293e4498fce7218e4e0935a80e4fd3b47a6e`); integrated as `dd42bea32f` (pre-2026-08-09 active) → `d6271418fd` (pre-2026-08-14 active) → `d352c1028b` (pre-refresh active) → `cfcff7efb8` (pre-2026-08-23 active) → `0a7cf47bc7` (pre-drop candidate) → `31c371f682` (pre-final-refresh active) → `5329a73341` (pre-2026-08-27 active) → `1e8f8e2e28` (pre-final-refresh active) → `f5c0467155` (pre-final-refresh-2 active) → `1a37c28961` (pre-2026-08-31 active) → `f965496f8c` (pre-2026-09-05 active) → `1d9fe7129f` (active)
