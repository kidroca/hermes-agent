...
- Patch ref: original `5c79641a3`; reviewed rebase `3ddcb19a6` → `3369b6147` (pre-2026-08-09 active) → `94bb2d8215` (pre-2026-08-14 active) → `efc0fad22b` (pre-refresh active) → `26e282bc8c` (pre-2026-08-23 active) → `079a4c7da2` (active)
