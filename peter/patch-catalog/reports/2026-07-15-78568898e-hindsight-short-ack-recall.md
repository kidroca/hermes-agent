...
- Patch ref: `78568898e` (reviewed) → `7b85e970e` (pre-2026-08-09 active) → `f120632b37` (pre-2026-08-14 active) → `dc959bb70f` (pre-refresh active) → `8e7a126e4c` (pre-2026-08-23 active) → `ddb78e01f9` (pre-final-refresh active) → `af44c7fa21` (active)
