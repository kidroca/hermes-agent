...
- Patch ref: `034d505a4` (reviewed) → `630f674e1` (pre-2026-08-09 active) → `02e84d55ad` (pre-2026-08-14 active) → `87d27ae8a0` (pre-refresh active) → `4a0ca5de69` (pre-2026-08-23 active) → `a493780fe8` (active)
